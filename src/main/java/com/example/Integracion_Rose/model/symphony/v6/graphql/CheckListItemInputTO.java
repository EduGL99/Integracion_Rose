...
public class CheckListItemInputTO implements java.io.Serializable {
    ...
    @javax.validation.constraints.NotNull
    private java.util.List<FileInputTO> files;
    ...
    public java.util.List<FileInputTO> getFiles() {
        return files;
    }

    public void setFiles(java.util.List<FileInputTO> files) {
        this.files = files;
    }
    ...
    public static class Builder {
        ...
        public Builder setFiles(java.util.List<FileInputTO> files) {
            this.files = files;
            return this;
        }
        ...
        public CheckListItemInputTO build() {
            return new CheckListItemInputTO(id, title, type, index, isMandatory, helpText, enumValues, enumSelectionMode, selectedEnumValues, stringValue, checked, files, yesNoResponse, wifiData, cellData);
        }

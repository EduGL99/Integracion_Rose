...
public class OrganizationFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private OrganizationFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public OrganizationFilterInputTO() {
    }

    public OrganizationFilterInputTO(OrganizationFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public OrganizationFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(OrganizationFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(OrganizationFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public OrganizationFilterInputTO build() {
            return new OrganizationFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

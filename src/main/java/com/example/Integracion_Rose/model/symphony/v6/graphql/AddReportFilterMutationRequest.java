...
public class AddReportFilterMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "addReportFilter";
    ...
    public AddReportFilterMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public AddReportFilterMutationRequest build() {
            AddReportFilterMutationRequest obj = new AddReportFilterMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

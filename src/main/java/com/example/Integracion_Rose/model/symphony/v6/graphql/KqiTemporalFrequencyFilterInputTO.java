...
public class KqiTemporalFrequencyFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private KqiTemporalFrequencyFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public KqiTemporalFrequencyFilterInputTO() {
    }

    public KqiTemporalFrequencyFilterInputTO(KqiTemporalFrequencyFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public KqiTemporalFrequencyFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(KqiTemporalFrequencyFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(KqiTemporalFrequencyFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public KqiTemporalFrequencyFilterInputTO build() {
            return new KqiTemporalFrequencyFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

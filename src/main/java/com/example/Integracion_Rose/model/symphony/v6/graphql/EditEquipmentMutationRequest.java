...
public class EditEquipmentMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "editEquipment";
    ...
    public EditEquipmentMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public EditEquipmentMutationRequest build() {
            EditEquipmentMutationRequest obj = new EditEquipmentMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

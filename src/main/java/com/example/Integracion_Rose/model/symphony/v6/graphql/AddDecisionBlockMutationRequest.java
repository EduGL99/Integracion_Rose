...
public class AddDecisionBlockMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "addDecisionBlock";
    ...
    public AddDecisionBlockMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public AddDecisionBlockMutationRequest build() {
            AddDecisionBlockMutationRequest obj = new AddDecisionBlockMutationRequest($alias);

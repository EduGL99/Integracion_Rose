...
public class EditFlowInstanceMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "editFlowInstance";
    ...
    public EditFlowInstanceMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public EditFlowInstanceMutationRequest build() {
            EditFlowInstanceMutationRequest obj = new EditFlowInstanceMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

...
public class RemoveServicePortMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "removeServicePort";
    ...
    public RemoveServicePortMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public RemoveServicePortMutationRequest build() {
            RemoveServicePortMutationRequest obj = new RemoveServicePortMutationRequest($alias);
            obj.setId(id);

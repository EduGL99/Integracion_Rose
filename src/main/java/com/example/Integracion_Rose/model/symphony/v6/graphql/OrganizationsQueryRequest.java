...
public class OrganizationsQueryRequest implements GraphQLOperationRequest {
    ...
    public void setOrderBy(OrganizationOrderTO orderBy) {
        this.input.put("orderBy", orderBy);
    }

    public void setFilterBy(List<OrganizationFilterInputTO> filterBy) {
    ...
    public static class Builder {
        ...
        private OrganizationOrderTO orderBy;
        private List<OrganizationFilterInputTO> filterBy;
        ...
        public Builder setOrderBy(OrganizationOrderTO orderBy) {
            this.orderBy = orderBy;
            return this;
        }

        public Builder setFilterBy(List<OrganizationFilterInputTO> filterBy) {

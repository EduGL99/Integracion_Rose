...
public class EditAlarmFilterInputTO implements java.io.Serializable {
    ...
    public EditAlarmFilterInputTO() {
    }

    public EditAlarmFilterInputTO(String id, String name, String networkResource, boolean enable, String beginTime, String endTime, String reason, String alarmStatus) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public EditAlarmFilterInputTO build() {
            return new EditAlarmFilterInputTO(id, name, networkResource, enable, beginTime, endTime, reason, alarmStatus);
        }

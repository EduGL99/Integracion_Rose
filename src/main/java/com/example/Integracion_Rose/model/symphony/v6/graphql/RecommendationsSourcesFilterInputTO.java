...
public class RecommendationsSourcesFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private RecommendationsSourcesFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public RecommendationsSourcesFilterInputTO() {
    }

    public RecommendationsSourcesFilterInputTO(RecommendationsSourcesFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public RecommendationsSourcesFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(RecommendationsSourcesFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(RecommendationsSourcesFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public RecommendationsSourcesFilterInputTO build() {
            return new RecommendationsSourcesFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

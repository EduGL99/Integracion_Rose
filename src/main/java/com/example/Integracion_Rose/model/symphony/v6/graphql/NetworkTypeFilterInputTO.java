...
public class NetworkTypeFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private NetworkTypeFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public NetworkTypeFilterInputTO() {
    }

    public NetworkTypeFilterInputTO(NetworkTypeFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public NetworkTypeFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(NetworkTypeFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(NetworkTypeFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public NetworkTypeFilterInputTO build() {
            return new NetworkTypeFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

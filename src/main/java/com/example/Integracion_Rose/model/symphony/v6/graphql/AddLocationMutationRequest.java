...
public class AddLocationMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "addLocation";
    ...
    public AddLocationMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public AddLocationMutationRequest build() {
            AddLocationMutationRequest obj = new AddLocationMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

...
public class CounterFamilyFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private CounterFamilyFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public CounterFamilyFilterInputTO() {
    }

    public CounterFamilyFilterInputTO(CounterFamilyFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public CounterFamilyFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(CounterFamilyFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(CounterFamilyFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public CounterFamilyFilterInputTO build() {
            return new CounterFamilyFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

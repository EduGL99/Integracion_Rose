...
public class EditEquipmentPortTypeMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "editEquipmentPortType";
    ...
    public EditEquipmentPortTypeMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public EditEquipmentPortTypeMutationRequest build() {
            EditEquipmentPortTypeMutationRequest obj = new EditEquipmentPortTypeMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

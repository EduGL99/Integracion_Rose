...
public class RemoveServiceEndpointMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "removeServiceEndpoint";
    ...
    public RemoveServiceEndpointMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public RemoveServiceEndpointMutationRequest build() {
            RemoveServiceEndpointMutationRequest obj = new RemoveServiceEndpointMutationRequest($alias);

...
public class AlarmFilterFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private AlarmFilterFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public AlarmFilterFilterInputTO() {
    }

    public AlarmFilterFilterInputTO(AlarmFilterFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public AlarmFilterFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(AlarmFilterFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(AlarmFilterFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public AlarmFilterFilterInputTO build() {
            return new AlarmFilterFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

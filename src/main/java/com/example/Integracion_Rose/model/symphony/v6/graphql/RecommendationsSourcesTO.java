...
public class RecommendationsSourcesTO implements java.io.Serializable, NodeTO {
    ...
    public RecommendationsSourcesTO() {
    }

    public RecommendationsSourcesTO(String id, String name, java.util.List<RecommendationsTO> recommendations) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public RecommendationsSourcesTO build() {
            return new RecommendationsSourcesTO(id, name, recommendations);
        }

...
public class PropertyTypeTO implements java.io.Serializable, NodeTO {
    ...
    public static class Builder {
        ...
        public PropertyTypeTO build() {
            return new PropertyTypeTO(id, externalId, name, type, nodeType, index, category, rawValue, stringValue, intValue, booleanValue, floatValue, latitudeValue, longitudeValue, rangeFromValue, rangeToValue, isEditable, isInstanceProperty, isMandatory, isDeleted, isListable);
        }

...
public class KqiPerspectiveFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private KqiPerspectiveFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public KqiPerspectiveFilterInputTO() {
    }

    public KqiPerspectiveFilterInputTO(KqiPerspectiveFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public KqiPerspectiveFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(KqiPerspectiveFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(KqiPerspectiveFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public KqiPerspectiveFilterInputTO build() {
            return new KqiPerspectiveFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

...
public class AlarmStatusFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private AlarmStatusFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public AlarmStatusFilterInputTO() {
    }

    public AlarmStatusFilterInputTO(AlarmStatusFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public AlarmStatusFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(AlarmStatusFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(AlarmStatusFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public AlarmStatusFilterInputTO build() {
            return new AlarmStatusFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

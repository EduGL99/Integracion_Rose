...
public class ComparatorFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private ComparatorFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public ComparatorFilterInputTO() {
    }

    public ComparatorFilterInputTO(ComparatorFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public ComparatorFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(ComparatorFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(ComparatorFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public ComparatorFilterInputTO build() {
            return new ComparatorFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

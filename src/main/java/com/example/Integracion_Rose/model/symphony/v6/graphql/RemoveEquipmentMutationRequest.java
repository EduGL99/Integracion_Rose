...
public class RemoveEquipmentMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "removeEquipment";
    ...
    public RemoveEquipmentMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public RemoveEquipmentMutationRequest build() {
            RemoveEquipmentMutationRequest obj = new RemoveEquipmentMutationRequest($alias);
            obj.setId(id);

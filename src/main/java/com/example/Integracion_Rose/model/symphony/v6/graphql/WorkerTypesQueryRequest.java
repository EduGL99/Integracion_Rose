...
public class WorkerTypesQueryRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "workerTypes";
    ...
    public WorkerTypesQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public WorkerTypesQueryRequest build() {
            WorkerTypesQueryRequest obj = new WorkerTypesQueryRequest($alias);
            obj.setAfter(after);
            obj.setFirst(first);

...
public class EquipmentFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private EquipmentFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public EquipmentFilterInputTO() {
    }

    public EquipmentFilterInputTO(EquipmentFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, PropertyTypeInputTO propertyValue, java.util.List<String> idSet, java.util.List<String> stringSet, Integer maxDepth) {
    ...
    public EquipmentFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(EquipmentFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(EquipmentFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public EquipmentFilterInputTO build() {
            return new EquipmentFilterInputTO(filterType, operator, stringValue, propertyValue, idSet, stringSet, maxDepth);
        }

...
public class SearchForNodeQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "searchForNode";
    public static final GraphQLOperation OPERATION_TYPE = GraphQLOperation.QUERY;
    private final Map<String, Object> input = new LinkedHashMap<>();
    private final Set<String> useObjectMapperForInputSerialization = new HashSet<>();
    private String alias;

    public SearchForNodeQueryRequest() {
    }

    public SearchForNodeQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public SearchForNodeQueryRequest build() {
            SearchForNodeQueryRequest obj = new SearchForNodeQueryRequest($alias);
            obj.setName(name);
            obj.setAfter(after);
            obj.setFirst(first);

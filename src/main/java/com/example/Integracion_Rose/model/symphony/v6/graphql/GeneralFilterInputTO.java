...
public class GeneralFilterInputTO implements java.io.Serializable {
    ...
    public GeneralFilterInputTO() {
    }

    public GeneralFilterInputTO(String filterType, String key, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, java.util.List<String> stringSet, Boolean boolValue, PropertyTypeInputTO propertyValue) {
    ...
    public static class Builder {
        ...
        public GeneralFilterInputTO build() {
            return new GeneralFilterInputTO(filterType, key, operator, stringValue, idSet, stringSet, boolValue, propertyValue);
        }

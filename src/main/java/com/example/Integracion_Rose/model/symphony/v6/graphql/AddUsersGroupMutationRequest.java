...
public class AddUsersGroupMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "addUsersGroup";
    ...
    public AddUsersGroupMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public AddUsersGroupMutationRequest build() {
            AddUsersGroupMutationRequest obj = new AddUsersGroupMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

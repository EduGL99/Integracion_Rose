...
public class EditLinkMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "editLink";
    ...
    public EditLinkMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public EditLinkMutationRequest build() {
            EditLinkMutationRequest obj = new EditLinkMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

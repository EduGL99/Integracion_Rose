...
public class KpiFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private KpiFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public KpiFilterInputTO() {
    }

    public KpiFilterInputTO(KpiFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public KpiFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(KpiFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(KpiFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public KpiFilterInputTO build() {
            return new KpiFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

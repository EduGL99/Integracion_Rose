...
public class LinksQueryRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "links";
    ...
    public LinksQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public void setFilterBy(List<LinkFilterInputTO> filterBy) {
    ...
    public static class Builder {
        ...
        private List<LinkFilterInputTO> filterBy;
        ...
        public Builder setFilterBy(List<LinkFilterInputTO> filterBy) {
        ...
        public LinksQueryRequest build() {
            LinksQueryRequest obj = new LinksQueryRequest($alias);
            obj.setAfter(after);
            obj.setFirst(first);

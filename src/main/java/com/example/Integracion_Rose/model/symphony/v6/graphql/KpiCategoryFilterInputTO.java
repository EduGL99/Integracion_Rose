...
public class KpiCategoryFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private KpiCategoryFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public KpiCategoryFilterInputTO() {
    }

    public KpiCategoryFilterInputTO(KpiCategoryFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public KpiCategoryFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(KpiCategoryFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(KpiCategoryFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public KpiCategoryFilterInputTO build() {
            return new KpiCategoryFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

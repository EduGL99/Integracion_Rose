...
public class AddLocationTypeMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "addLocationType";
    ...
    public AddLocationTypeMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public AddLocationTypeMutationRequest build() {
            AddLocationTypeMutationRequest obj = new AddLocationTypeMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

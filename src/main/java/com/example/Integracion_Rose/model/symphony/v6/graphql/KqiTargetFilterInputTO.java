...
public class KqiTargetFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private KqiTargetFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public KqiTargetFilterInputTO() {
    }

    public KqiTargetFilterInputTO(KqiTargetFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public KqiTargetFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(KqiTargetFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(KqiTargetFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public KqiTargetFilterInputTO build() {
            return new KqiTargetFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

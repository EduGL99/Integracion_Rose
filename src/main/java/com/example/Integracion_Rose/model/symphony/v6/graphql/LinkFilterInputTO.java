...
public class LinkFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private LinkFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public LinkFilterInputTO() {
    }

    public LinkFilterInputTO(LinkFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, PropertyTypeInputTO propertyValue, java.util.List<String> idSet, java.util.List<String> stringSet, Integer maxDepth) {
    ...
    public LinkFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(LinkFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(LinkFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public LinkFilterInputTO build() {
            return new LinkFilterInputTO(filterType, operator, stringValue, propertyValue, idSet, stringSet, maxDepth);
        }

...
public class TechnicianWorkOrderCheckOutMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "technicianWorkOrderCheckOut";
    ...
    public TechnicianWorkOrderCheckOutMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public TechnicianWorkOrderCheckOutMutationRequest build() {
            TechnicianWorkOrderCheckOutMutationRequest obj = new TechnicianWorkOrderCheckOutMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

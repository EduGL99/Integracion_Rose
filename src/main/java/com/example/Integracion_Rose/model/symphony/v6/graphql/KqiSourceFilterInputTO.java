...
public class KqiSourceFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private KqiSourceFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public KqiSourceFilterInputTO() {
    }

    public KqiSourceFilterInputTO(KqiSourceFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public KqiSourceFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(KqiSourceFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(KqiSourceFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public KqiSourceFilterInputTO build() {
            return new KqiSourceFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

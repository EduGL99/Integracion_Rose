...
public class RemoveServiceLinkMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "removeServiceLink";
    ...
    public RemoveServiceLinkMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public RemoveServiceLinkMutationRequest build() {
            RemoveServiceLinkMutationRequest obj = new RemoveServiceLinkMutationRequest($alias);
            obj.setId(id);

...
public class EditProjectMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "editProject";
    ...
    public EditProjectMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public EditProjectMutationRequest build() {
            EditProjectMutationRequest obj = new EditProjectMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

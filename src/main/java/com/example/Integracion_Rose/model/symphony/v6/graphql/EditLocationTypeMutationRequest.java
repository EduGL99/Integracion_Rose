...
public class EditLocationTypeMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "editLocationType";
    ...
    public EditLocationTypeMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public EditLocationTypeMutationRequest build() {
            EditLocationTypeMutationRequest obj = new EditLocationTypeMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

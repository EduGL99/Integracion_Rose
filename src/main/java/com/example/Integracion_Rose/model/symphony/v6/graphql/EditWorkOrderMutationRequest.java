...
public class EditWorkOrderMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "editWorkOrder";
    ...
    public EditWorkOrderMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public EditWorkOrderMutationRequest build() {
            EditWorkOrderMutationRequest obj = new EditWorkOrderMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

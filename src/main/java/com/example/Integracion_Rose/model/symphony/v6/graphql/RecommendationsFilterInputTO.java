...
public class RecommendationsFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private RecommendationsFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public RecommendationsFilterInputTO() {
    }

    public RecommendationsFilterInputTO(RecommendationsFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, Boolean boolValue, Integer intValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public RecommendationsFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(RecommendationsFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(RecommendationsFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public RecommendationsFilterInputTO build() {
            return new RecommendationsFilterInputTO(filterType, operator, stringValue, boolValue, intValue, idSet, maxDepth, stringSet);
        }

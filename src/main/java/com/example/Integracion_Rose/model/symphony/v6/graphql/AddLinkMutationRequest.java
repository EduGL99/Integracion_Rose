...
public class AddLinkMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "addLink";
    ...
    public AddLinkMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public AddLinkMutationRequest build() {
            AddLinkMutationRequest obj = new AddLinkMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

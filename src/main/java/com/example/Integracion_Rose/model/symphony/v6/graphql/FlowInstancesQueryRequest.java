...
public class FlowInstancesQueryRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "flowInstances";
    ...
    public FlowInstancesQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public void setFilterBy(List<FlowInstanceFilterInputTO> filterBy) {
    ...
    public static class Builder {
        ...
        private List<FlowInstanceFilterInputTO> filterBy;
        ...
        public Builder setFilterBy(List<FlowInstanceFilterInputTO> filterBy) {
        ...
        public FlowInstancesQueryRequest build() {
            FlowInstancesQueryRequest obj = new FlowInstancesQueryRequest($alias);
            obj.setAfter(after);
            obj.setFirst(first);

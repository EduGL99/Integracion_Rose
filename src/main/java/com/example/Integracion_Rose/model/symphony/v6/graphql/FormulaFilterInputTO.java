...
public class FormulaFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private FormulaFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public FormulaFilterInputTO() {
    }

    public FormulaFilterInputTO(FormulaFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet, Boolean boolValue) {
    ...
    public FormulaFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(FormulaFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(FormulaFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public FormulaFilterInputTO build() {
            return new FormulaFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet, boolValue);
        }

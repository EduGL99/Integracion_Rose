...
public class KqiCategoryFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private KqiCategoryFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public KqiCategoryFilterInputTO() {
    }

    public KqiCategoryFilterInputTO(KqiCategoryFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public KqiCategoryFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(KqiCategoryFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(KqiCategoryFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public KqiCategoryFilterInputTO build() {
            return new KqiCategoryFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

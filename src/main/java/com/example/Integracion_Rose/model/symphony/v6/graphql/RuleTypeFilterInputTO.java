...
public class RuleTypeFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private RuleTypeFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public RuleTypeFilterInputTO() {
    }

    public RuleTypeFilterInputTO(RuleTypeFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public RuleTypeFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(RuleTypeFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(RuleTypeFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public RuleTypeFilterInputTO build() {
            return new RuleTypeFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

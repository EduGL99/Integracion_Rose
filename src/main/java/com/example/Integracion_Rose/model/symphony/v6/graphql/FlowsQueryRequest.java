...
public class FlowsQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "flows";
    public static final GraphQLOperation OPERATION_TYPE = GraphQLOperation.QUERY;
    private final Map<String, Object> input = new LinkedHashMap<>();
    private final Set<String> useObjectMapperForInputSerialization = new HashSet<>();
    private String alias;

    public FlowsQueryRequest() {
    }

    public FlowsQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public FlowsQueryRequest build() {
            FlowsQueryRequest obj = new FlowsQueryRequest($alias);
            obj.setAfter(after);
            obj.setFirst(first);

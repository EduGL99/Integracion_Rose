...
public class EditEquipmentTypeMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "editEquipmentType";
    ...
    public EditEquipmentTypeMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public EditEquipmentTypeMutationRequest build() {
            EditEquipmentTypeMutationRequest obj = new EditEquipmentTypeMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

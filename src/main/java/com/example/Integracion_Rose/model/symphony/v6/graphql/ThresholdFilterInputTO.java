...
public class ThresholdFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private ThresholdFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public ThresholdFilterInputTO() {
    }

    public ThresholdFilterInputTO(ThresholdFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public ThresholdFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(ThresholdFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(ThresholdFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public ThresholdFilterInputTO build() {
            return new ThresholdFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

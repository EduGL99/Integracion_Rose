...
public class AddHyperlinkMutationRequest implements GraphQLOperationRequest {
    ...
    public static final String OPERATION_NAME = "addHyperlink";
    ...
    public AddHyperlinkMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static class Builder {
        ...
        public AddHyperlinkMutationRequest build() {
            AddHyperlinkMutationRequest obj = new AddHyperlinkMutationRequest($alias);
            obj.setInput(input);
            return obj;
        }

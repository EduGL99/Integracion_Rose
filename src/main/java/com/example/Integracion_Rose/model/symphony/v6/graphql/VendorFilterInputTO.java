...
public class VendorFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private VendorFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public VendorFilterInputTO() {
    }

    public VendorFilterInputTO(VendorFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public VendorFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(VendorFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(VendorFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public VendorFilterInputTO build() {
            return new VendorFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

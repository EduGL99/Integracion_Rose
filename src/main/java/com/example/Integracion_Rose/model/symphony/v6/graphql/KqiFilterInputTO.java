...
public class KqiFilterInputTO implements java.io.Serializable {

    @javax.validation.constraints.NotNull
    private KqiFilterTypeTO filterType;
    @javax.validation.constraints.NotNull
    ...
    public KqiFilterInputTO() {
    }

    public KqiFilterInputTO(KqiFilterTypeTO filterType, FilterOperatorTO operator, String stringValue, java.util.List<String> idSet, Integer maxDepth, java.util.List<String> stringSet) {
    ...
    public KqiFilterTypeTO getFilterType() {
        return filterType;
    }

    public void setFilterType(KqiFilterTypeTO filterType) {
        this.filterType = filterType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFilterType(KqiFilterTypeTO filterType) {
            this.filterType = filterType;
            return this;
        }
        ...
        public KqiFilterInputTO build() {
            return new KqiFilterInputTO(filterType, operator, stringValue, idSet, maxDepth, stringSet);
        }

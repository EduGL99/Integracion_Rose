...
public class CustomGraphQLRequestSerializer {

    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();

    public static String toHttpJsonBody(CustomGraphQLRequests graphQLRequests) {
        ...
        for (CustomGraphQLRequest request : graphQLRequests.getCustomRequests()) {
     ...
     */
    public static String toHttpJsonBody(CustomGraphQLRequest graphQLRequest) {
     ...
     * @return the serialized request
     */
    public static String toQueryString(CustomGraphQLRequest graphQLRequest) {
        if (graphQLRequest == null || graphQLRequest.getRequest() == null) {
            return null;
        }
    ...
    private static String buildQuery(CustomGraphQLRequest graphQLRequest) {
        ...
        FragmentNode fragment = graphQLRequest.getRequest().getInlineFragment();
        if (fragment != null) {
            builder.append(" { ... on ").append(fragment).append(" ");
        }
